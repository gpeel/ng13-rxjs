 ...
 */
export class StateFilter33LocalResolverCachedComponent implements OnInit {
  filteredStates!: State[];
  filter: FormControl;
  states!: State[]; // take from Resolver

  constructor(private activatedRoute: ActivatedRoute,
              private statesCache33WithBehaviorSubject: StatesCache33WithBehaviorSubject) {
    ...
    // Here synchro
    this.states = this.statesCache33WithBehaviorSubject.getDataValue();
  }
